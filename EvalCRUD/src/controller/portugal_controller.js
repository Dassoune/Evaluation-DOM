...
exports.getDataForPortugal = (request, response) => {
...
exports.getDataByIdForPortugal = (request, response) => {
  // Lecture du contenu du fichier
  fs.readFile(dataPath, (err, data) => {
    // Si il y a une erreur dans la lecture on renvoie une erreur avec un message
    if (err) {
...
exports.getDataByNameForPortugal = (request, response) => {
  // Lecture du contenu du fichier
  fs.readFile(dataPath, (err, data) => {
    // Si il y a une erreur dans la lecture on renvoie une erreur avec un message
    if (err) {
...
exports.createDataForPortugal = (request, response) => {
  // Lecture du contenu du fichier
  fs.readFile(dataPath, (err, data) => {
    // Si il y a une erreur dans la lecture on renvoie une erreur avec un message
    if (err) {
      ...
      const newID = existingData.portugal[existingData.portugal.length - 1].id + 1;
...
exports.updateDataForPortugal = (request, response) => {
  // Lecture du contenu du fichier
...
exports.deleteDataForPortugal = (request, response) => {
  // Lecture du contenu du fichier
  fs.readFile("./src/model/data.json", (err, data) => {
    // Si il y a une erreur dans la lecture on renvoie une erreur avec un message
    if (err) {
